...
export default async function SubscribePage({
  ...
  const errorMessage = checkoutErrorMessage(firstParam((await searchParams).error));
  ...
  return (
    <Container
      ...
      size="narrow"
    >
      <section className="mx-auto grid w-full max-w-[36rem] gap-7 rounded-[1.75rem] border border-border-strong bg-surface-grad p-6 shadow-card-deep sm:p-9">

// Dynamic route for OG image generation
...
export async function GET(
	...
	try {
		...
		console.log('Fetching resource for slug:', slug)
		...
		// If no resource found, use slug as title
		if (!title) {
			...
			>
				<div tw="flex items-center absolute right-16 bottom-16 justify-center h-12 w-48">
					...
					>
						...
						<path
							fill="#e0e0e0"
							d="M159,92.27a10.46,10.46,0,0,0-10.57,8.8,137.84,137.84,0,0,0-2.10,17.29,22.14,22.14,0,0,0,.44,4.84c.42-4.18,1-8.16,1.65-11.62a10.46,10.46,0,0,1,10.57-8.8,286.72,286.72,0,0,1,37.67,2.86c-1.18-3.67-2.45-7.35-3.81-11A284.59,284.59,0,0,0,159,92.27Z"
						/>
						<path
							fill="#56555c"
						...
						<path
							fill="#fffffb"
							d="M361.45,147.89a33.07,33.07,0,0,1-4.59,9.74,33.65,33.65,0,0,1-7.65,8,36.81,36.81,0,0,1-10.55,5.4,41.81,41.81,0,0,1-13.29,2,43.55,43.55,0,0,1-15.62-2.82,37.8,37.8,0,0,1-13-8.29,39.75,39.75,0,0,1-8.94-13.37,45.93,45.93,0,0,1-3.30-17.88,44.4,44.4,0,0,1,3.22-17.23,40.14,40.14,0,0,1,8.62-13.13,38.71,38.71,0,0,1,12.48-8.38,37.46,37.46,0,0,1,14.66-3q18.52,0,28.83,11T362.57,130q0,2.26-.16,4.27t-.16,2.33H305.56a17.07,17.07,0,0,0,1.85,7.17,19.92,19.92,0,0,0,4.35,5.72,19.61,19.61,0,0,0,6.20,3.79,20.79,20.79,0,0,0,7.57,1.37q7.57,0,11.84-3.38a19.26,19.26,0,0,0,6.2-8.7Zm-20-25.93a19.41,19.41,0,0,0-1.21-5.72,13.8,13.8,0,0,0-3.22-5,16.63,16.63,0,0,0-5.48-3.54,20.33,20.33,0,0,0-7.81-1.37,17.91,17.91,0,0,0-7.41,1.45,18.24,18.24,0,0,0-5.48,3.71,16.4,16.4,0,0,0-3.46,5A15.78,15.78,0,0,0,306,122Z"
						/>
						<path
							fill="#fffffb"
						...
						<path
							fill="#fffffb"
							d="M889,162.28a8,8,0,0,1,2.35-5.81,7.73,7.73,0,0,1,5.76-2.41,8.22,8.22,0,0,1,8.22,8.22,7.73,7.73,0,0,1-2.41,5.76,8,8,0,0,1-5.81,2.35,8,8,0,0,1-8.10-8.10Z"
						/>
						<path
							fill="#fffffb"
						...
						<path
							fill="#fffffb"
							d="M947.71,133c0-21.21,14.86-39.17,39.48-39.17,24.77,0,39.63,18,39.63,39.17s-14.86,39.33-39.63,39.33C962.57,172.36,947.71,154.25,947.71,133Zm58.68,0c0-11.61-6.81-21.68-19.20-21.68-12.23,0-19,10.06-19,21.68,0,11.77,6.81,21.83,19,21.83C999.57,154.87,1006.39,144.8,1006.39,133Z"
						/>
					</svg>
				</div>

...
export function createAuthJsAdapter(storage: AuthStoragePort & Pick<IdentityPort, "createUser" | "getUser" | "getUserByEmail" | "getUserByAccount" | "updateUser" | "linkAccount" | "unlinkAccount" | "createVerificationToken">): Adapter {
  return {
    ...storage,

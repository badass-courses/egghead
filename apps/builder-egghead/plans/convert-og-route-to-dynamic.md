...
**Package:** `@coursebuilder/utils/og-image`
...
1. **Update `@coursebuilder/utils/og-image.ts`:**
...
3. ✅ `/packages/coursebuilder-utils/src/og-image.ts` - UPDATE: Change URL generation
...
10. ✅ `/packages/coursebuilder-utils/src/og-image.test.ts` - UPDATE: Tests for new URL
    format
...
**Impact:** Other apps using `@coursebuilder/utils/og-image`
**Mitigation:**

...
**File:** `/packages/coursebuilder-utils/src/og-image.ts`
...
3. ✅ `/packages/coursebuilder-utils/src/og-image.ts` - UPDATED (URL generation)
...
1. Revert `/packages/coursebuilder-utils/src/og-image.ts`
